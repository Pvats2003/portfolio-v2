...
|---|---|---|---|
| Look-dev frames (`/world/lookdev`) | `components/world/lookdev/` | Drawn in code: SVG shapes and gradients, and 3D primitives | Ours |
...
| Posters | `public/world/poster-*.{avif,webp}` | Rendered from our own scene by `scripts/world-posters.cjs` | Ours |
