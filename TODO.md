...
- [ ] Resume PDF's LinkedIn link is `linkedin.com/in/priyanshuvats-5a68aa292` (no hyphen); the correct one is `linkedin.com/in/priyanshu-vats-5a68aa292`, which the site uses. Fix it in the corrected PDF.
- [ ] Resume PDF still lists IBM Business Analyst and IBM Program Manager, which Priyanshu didn't complete (removed from the site on Sep 25). Upload a corrected PDF.
